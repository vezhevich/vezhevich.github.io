$(function() {
    ...
    // кастомный скролл dropdown
    $(window).on("load",function(){
        $(".js-b-dropdown__list").mCustomScrollbar();
    });

    // кастомный скролл на карте
    $(window).on("load",function(){
        $(".js-b-map__list").mCustomScrollbar();
    });
});

// детальный блок локаций в карте
$(function() {
    ...
    $('.js-tab-content__close').click(function(e) {
        e.preventDefault();
        $('.js-tab-trigger.active').removeClass('active');
        $('.js-tab-content.active').removeClass('active');
    });
    ...
    $('.js-modal').magnificPopup({
        ...
        callbacks: {
            ...
            open: function () {
                ...
                $('.l-footer-wrapper').addClass('left-window');
            },
            beforeClose: function() {
                $('.l-footer-wrapper').removeClass('left-window');
            },
            close: function () {
